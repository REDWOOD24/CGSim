...
public:
    ...
    static sg4::CommPtr  comm_file_async(Job* j, const std::string& filename, const std::string& src_site, const std::string& dst_site, const unsigned long long& size, std::unique_ptr<DispatcherPlugin>& dispatcher, FileTransferMode mode = FileTransferMode::COPY);
