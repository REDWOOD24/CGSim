...
output = Path("site_topology.json")
topology = {}
...
for site_index in range(30):
    ...
    storage_capacity_bytes = total_file_bytes * 1000 + rng.randint(1, 10_000_000_000)
...
for site_data in topology.values():
    ...
    capacity_checks.append(capacity > site_total * 1000)
...
print("All storage capacities > site file-byte totals × 1000: True")
